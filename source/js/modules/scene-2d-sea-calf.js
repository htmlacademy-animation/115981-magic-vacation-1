...
import _ from '../helpers/util.js';


const imagesPath = `/img/module-4/win-primary-images/`;
const IMAGES_URLS = Object.freeze({
  plane: `${imagesPath}airplane.png`,
  tree: `${imagesPath}tree.png`,
  tree2: `${imagesPath}tree 2.png`,
  ice: `${imagesPath}ice.png`,
  seaCalf: `${imagesPath}sea-calf-2.png`,
  snowflake: `${imagesPath}snowflake.png`
});
...
export default class Scene2DSeaCalf extends Scene2D {
  ...
  drawBlob() {
    ...
    this.ctx.beginPath();
    this.ctx.arc(b.centerX * s, b.centerY * s, b.radius * s, Math.PI / 2, Math.PI * 3 / 2);
    this.ctx.bezierCurveTo((b.centerX + 10) * s, (b.centerY - b.radius) * s, (b.endX - b.deltasLength * Math.sin(angle)) * s, (b.endY + b.deltasLength * Math.cos(angle)) * s, b.endX * s, b.endY * s);
    this.ctx.bezierCurveTo((b.endX - b.deltasLength * Math.sin(angle)) * s, (b.endY + b.deltasLength * Math.cos(angle)) * s, (b.centerX + 10) * s, (b.centerY + b.radius) * s, b.centerX * s, (b.centerY + b.radius) * s);
